...
**Time:** ${{ values.team }} | **Runtime:** Python | **Sigla:** ${{ values.sigla }}
...
# → ci.yaml roda (build + test) — sem deploy

# Merge em develop → deploy automático no DEV
# Cria release/* → deploy automático no HML
...
sonar-scanner           # qualidade de código
```
